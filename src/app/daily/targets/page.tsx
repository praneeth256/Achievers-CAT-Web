...
type DailyPackage = { id: string; date?: string; quant?: { title?: string }[]; varc?: { type?: "RC" | "VA"; title?: string; questions?: unknown[] }; dilr?: { title?: string; questions?: unknown[] } };
